...
export const ADMIN_SIDEBAR_ASIDE =
  'admin-sidebar-home-bg hidden lg:flex lg:h-full lg:shrink-0 lg:flex-col border-r border-[#186340] bg-[#1f7a4d] text-white transition-[width] duration-200 ease-out';
