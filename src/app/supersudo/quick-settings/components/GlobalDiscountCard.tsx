  ...
  return (
    <div className="rounded-lg border border-[#f0ddd0] bg-white p-4">
      <div className="flex items-center gap-2 mb-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#fff4eb]">
          <svg className="h-5 w-5 text-[#f66812]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
