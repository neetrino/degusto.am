...
export function AuthPageShell({
  ...
  return (
    <div
      className={`relative z-20 flex min-h-0 flex-1 flex-col overflow-hidden ${AUTH_PAGE_BRAND_ORANGE_CLASS} ${AUTH_PAGE_DESKTOP_HEADER_OFFSET_CLASS}`}
    >
      <img
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 z-[1] bg-[linear-gradient(180deg,rgba(255,255,255,0.08)_0%,rgba(255,255,255,0.02)_32%,rgba(255,255,255,0)_100%)]"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 z-[2] bg-[radial-gradient(circle_at_50%_46%,rgba(255,220,168,0.16)_0%,rgba(255,220,168,0)_56%)]"
      />
      <div
